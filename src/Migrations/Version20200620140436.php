    ...
    public function up(Schema $schema) : void
    {
        $this->addSql('
            CREATE TABLE budget_request (
                ...
                INDEX IDX_budget_request_user_id (user_id),
                CONSTRAINT FK_budget_request_user_id FOREIGN KEY (user_id) REFERENCES user (id) ON UPDATE CASCADE ON DELETE CASCADE                 
